      ...
      <div className="px-4 md:px-6 lg:px-8 py-6 max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-neutral-700 leading-relaxed mb-4">
            Speedoo is a comprehensive e-commerce platform that connects customers
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-neutral-700">support@speedoo.com</span>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <svg
                width="20"
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-xs text-neutral-500 mt-1">
            © 2024 Speedoo. All rights reserved.
          </p>
        </div>
      </div>
    </div>
