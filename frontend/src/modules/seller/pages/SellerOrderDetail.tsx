...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Bill Generated by Speedoo - 10 Minute App", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
    ...
    doc.setFontSize(8);
    doc.text(
      "Copyright © 2025. Developed By Speedoo - 10 Minute App",
      pageWidth / 2,
      yPos,
      { align: "center" }
    );
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Speedoo - 10 Minute App
            </p>
          </div>
        </div>
      </div>
