      ...
      <div className="bg-[#9048A5] sticky top-0 z-10 shadow-sm">
        <div className="px-4 py-3 flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h1 className="text-lg font-bold text-white transition-all">
              Order Again
            </h1>
            <p className="text-[10px] text-purple-100 opacity-90 leading-none">
            ...
            <div className="relative w-full max-w-xs mb-4">
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative w-40 h-48 bg-gradient-to-b from-yellow-400 via-yellow-300 to-yellow-500 rounded-b-2xl rounded-t-lg shadow-xl border-2 border-yellow-500/30 flex items-center justify-center">
                  ...
                  {/* Speedoo text inside basket */}
                  <div className="relative z-10 text-center px-4">
                    <span className="text-2xl font-extrabold text-neutral-900 tracking-tight drop-shadow-sm">Speedoo</span>
